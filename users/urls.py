...
from . import views 
from users.views import ProfileView, CheckUsernameAvailability, EmailVerifyView
...
urlpatterns = [
    ...
    path('send-verification-code/', EmailVerifyView.as_view()),
    path('verify-code/', EmailVerifyView.as_view()),
